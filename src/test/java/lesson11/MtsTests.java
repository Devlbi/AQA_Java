...
public class MtsTests {
    ...
    @Test
    @io.qameta.allure.Feature("Проверка плейсхолдеров")
    @io.qameta.allure.Description("Тест проверяет подсказки (placeholder) во всех типах услуг оплаты")
    ...
    @Test
    @io.qameta.allure.Feature("Оплата связи")
    @io.qameta.allure.Story("Проверка платежного фрейма")
    @io.qameta.allure.Description("Тест проверяет ввод данных и их корректное отображение внутри iframe оплаты")
